...
// Implements the IWebBrowser2 interface to use the IE ActiveX control from this MFC app.
// This implementation has been generated by Visual Studio 2008 and has not been altered.
